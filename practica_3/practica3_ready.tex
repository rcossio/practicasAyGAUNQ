...
\end{enumerate}\exercise\begin{enumerate} [label=(\alph*)]		\item $d(P,Q) = \left| \vect{PQ} \right| = \left| (4,-2,-6) \right| \sqrt{4^2+(-2)^2+(-6)^2} = \sqrt{56} \simeq 7.4833$
		...
		\item Directamente conviene plantear $|\vec{v}|^2$ en vez de $|\vec{v}|$. $|\vec{v}|^2=2k^2+2k+1=5^2$, es decir, $2k^2+2k-24=0$. Resolviendo la ecuación obtenemos $k_1=3$ o $k_2=-4$. El vector es $\vec{v}_1=(3,4)$ o $\vec{v}_2=(-4,3)$
		\item Considerando las coordenadas polares se obtiene $\vec{v}=(\cos{\theta}, \sin{\theta})$. Por lo tanto $\vec{v}_{30 \degs}=\left(\df{\sqrt{3}}{2},\df{1}{2}\right)$, $\vec{v}_{60 \degs}=\left(\df{1}{2},\df{\sqrt{3}}{2}\right)$, $\vec{v}_{90 \degs}=\left(0,1\right)$, $\vec{v}_{135 \degs}=\left(\df{\sqrt{2}}{2},\df{\sqrt{2}}{2}\right)$ y $\vec{v}_{300 \degs}=\left(\df{1}{2},-\df{\sqrt{3}}{2}\right)$
\end{enumerate}\exercise---\exercise---\exercise---\exercise---\exercise---\exercise---\exercise---\exercise---\exercise---\exercise---\exercise---\exercise---\end{enumerate}\end{document}