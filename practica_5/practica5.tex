...
\begin{enumerate}
	...
	\begin{enumcols}
		...
		\answer Despejamos y calculamos $X=(C+2B).A^{-1}=\Mat{-\frac{1}{2} & \frac{1}{2} \\ -\frac{5}{2} & \frac{1}{4} }$
		...
		\answer Despejamos $X=A^{-1}.B$. (Calcular)

		\item $ (5X + AX)B = A $ considerando las matrices: \\ $A=\Mat{ 1 & -1 \\ 2 & 2}$ ~~~~~~ $B=\Mat{ 0 & 1 \\ 1 & 1}$. 
		\answer Despejamos: \\ $ (5X + AX)B = A $ \\ $ (5X + AX) = A.B^{-1} $ \\ $ (5I + A).X = A.B^{-1} $ \\ $ X = (5I + A)^{-1}.A.B^{-1}$.\\ (Calcular la operacion resultante) 
