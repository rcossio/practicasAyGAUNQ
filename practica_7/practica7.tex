...
\begin{enumerate}
	...
	\exercise Resolver los siguientes problemas integradores sobre la geometría en el espacio.
	\begin{enumcols}
		...
		\item Sean las rectas $r_1: x+1 = y+2 = \f{z}{3}$ ~~y ~~ $r_2:\SEL{x=1+2\lambda \\ y=\lambda \\ z=3-\lambda}$. Obtenga las ecuaciones de todos los planos $\pi$ tales que $\pi \perp r_1$ y $d(\pi, r_2)=\sqrt{11}$
		...
		\item Hallar todos los valores de $k\in\R$ tales que la distancia de la recta $r:\SEL{x+y+z=1 \\ x-kz=0}$ al origen de coordenadas sea $1$.
		\answer $k=-1$. Resolución por \href{https://youtu.be/UNMMktIFFAE}{Álgebra Para Todos}.

		\item Hallar el parámetro $a$ para que $L_1:\SEL{2x-4y+z+1=0 \\ x-2y+3z-2=0}$ ~~y~~ $L_2:\f{x-1}{a}=\f{y+2}{4}=z$ sean coplanares. Además encontrar todos los puntos $P$ pertenecientes al eje $y$ tal que la distancia al plano que contiene a $L_1$ y $L_2$ sea igual a $\sqrt{41}$
		...
		\item Dada la recta $L:\SEL{y=2x\\ z=1}$ y el plano $pl_{\alpha}: x+y+z=9$, hallar la ecuación del plano que contiene a la recta $L$ y es perpendicular a $pl_{\alpha}$. Luego, halle la proyección de la recta $L$ sobre $pl_{\alpha}$.
		...
		\item Hallar los valores de las constantes $a$ y $b$ para que la proyección de la recta $r:\SEL{x=-2t \\ y=1+at \\ z=bt}$ sobre el plano $\pi: x+2z=30$ resulte en un único punto y dar dicho punto.
		...
		\item Determine la ecuación de la recta que contiene al origen de coordenadas, es perpendicular a la recta $r: (x,y,z) = (-5, 0, -3) + \lambda(1,1,2)$ y es incidente a la recta $s: (x,y,z)=(0,1,2) + t (1,2,1)$.
		...
		\item Hallar la ecuación del plano que contiene a la recta $s:\SEL{x=3 \\ y=2}$ y forma un ángulo de $30\degs$ con la recta $r: (x,y,z) = (0,0,0) t(-1,0,1)$. Esquematizar la situación.
		...
		\item Hallar la proyección de $L: x-2=y-1=\f{-z-3}{2}$ sobre el plano $\pi: x+y+z=0$.
		...
		\item Hallar el punto de la recta $r:\SEL{x=1-t \\ y=3+t \\2+2t}$ cuya proyección sobre el plano $yz$ es $(0,1,-2)$.
