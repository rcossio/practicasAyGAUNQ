...
\begin{enumerate}
	...
	\exercise Resolver los siguientes sistemas mixtos
	\begin{enumcols}[2]
		
			\item $\SEL{x+y+z=6 \\ 2x-y+5z=9 \\ x^2 + y^2 = 10}$
			\answer Hay dos soluciones: $(x,y,z)=(1,3,2)$ y $(x,y,z)=\left(\f{9}{5},\f{13}{5},\f{8}{5}\right)$

			\item $\SEL{x+2y-z=5 \\ 3x-y+4z=8 \\ x^3 - 3y = 24}$
			\answer Hay tres soluciones: $(x,y,z)=(3,1,0)$, $(x,y,z)=\left(-\f{3}{2}+\f{i\sqrt{39}}{2},\f{11}{2}-\f{i\sqrt{39}}{2},\f{9}{2}-\f{i\sqrt{39}}{2}\right)$ y $(x,y,z)=\left(-\f{3}{2}-\f{i\sqrt{39}}{2},\f{11}{2}+\f{i\sqrt{39}}{2},\f{9}{2}+\f{i\sqrt{39}}{2}\right)$
	...
	\begin{enumcols}[2]
			...
			\item \img{8cm}{img/table_puzzle.png}
			\item \img{6.5cm}{img/fruit_puzzle.png}
			\item \img{4.5cm}{img/square_puzzle.png}
			\item \img{6.5cm}{img/fruit_puzzle2.png}
			\item \img{6.5cm}{img/weight_puzzle.png}
	...
	\begin{enumcols}
		...
		\item Una persona invierte en una acción cierta cantidad de dinero, obteniendo un 5\% de beneficio. Por otra inversión en un bono, obtiene un beneficio del 3\%. Sabiendo que en total invirtió 10.000\$, y que la ganancia de las acciones supera en 300\$ a la de los bonos, ¿cuánto dinero invirtió en acciones y cuánto en bonos?
		\answer Considerando $a$ el dinero invertido en acciones y $b$ el dinero invertido en bonos, la suma de las inversiones es: $a+b=10000$. La diferencia de ganancias es $\f{5}{100}a-\f{3}{100}b=300$. Solucionando el sistema obtenemos $(a,b)=(7500,2500)$, es decir, se invirtió 7500\$ en acciones y 2500\$ en bonos. 
	...
	\begin{enumcols}
		...
		\item MgS + AlCl$_3$ $\to$ MgCl$_2$ + Al$_2$S$_3$
		\answer Considerando $a$MgS + $b$AlCl$_3$ $\to$ $c$MgCl$_2$ + $d$Al$_2$S$_3$ la solución general es $(a,b,c,d)=\left(a,\f{2a}{3},c,\f{a}{3}\right)$. Una solución particular es 3MgS + 2AlCl$_3$ $\to$ 3MgCl$_2$ + Al$_2$S$_3$
		
		\item K$_2$Cr$_2$O$_7$ + H$_2$O + S $\to$ SO$_2$ + KOH + Cr$_2$O$_3$
		\answer Considerando $a$K$_2$Cr$_2$O$_7$ + $b$H$_2$O + $c$S $\to$ $d$SO$_2$ + $e$KOH + $f$Cr$_2$O$_3$ la solución general es $(a,b,c,d,e,f)=\left(\f{e}{2},\f{e}{2},\f{3e}{4},\f{3e}{4},e,\f{e}{2}\right)$. Una solución particular es 2K$_2$Cr$_2$O$_7$ + 2H$_2$O + 3S $\to$ 3SO$_2$ + 4KOH + 2Cr$_2$O$_3$

		\item K$_2$Cr$_2$O$_7$ + HI + HClO$_4$ $\to$ Cr(ClO$_4$)$_3$ + KClO$_4$ + I$_2$ + H$_2$O
		\answer Considerando $a$K$_2$Cr$_2$O$_7$ + $b$HI + $c$HClO$_4$ $\to$ $d$Cr(ClO$_4$)$_3$ + $e$KClO$_4$ + $f$I$_2$ + $g$H$_2$O la solución general es $(a,b,c,d,e,f,g)=(a,6a,8a,2a,2a,3a,7a)$. Una solución particular es K$_2$Cr$_2$O$_7$ + 6HI + 8HClO$_4$ $\to$ 2Cr(ClO$_4$)$_3$ + 2KClO$_4$ + 3I$_2$ + 7H$_2$O
	...
	\begin{enumcols}
		...
		\item Indicar los valores de $k \in \R$ para que el sistema sea compatible determinado. Resolver el sistema mediante el uso de la matriz inversa para uno de los valores hallados de $k$ (elegido arbitrariamente).
		\item Desarrollar la siguiente situación con herramientas vistas en la asignatura: \\ \textit{"Una tienda compró una caja de 100 bombones y otra de 150 caramelos para entregar a sus clientes en
		Halloween. A cada infante que compraba se le regalaban 3 caramelos y 2 bombones, y a cada persona
		adulta 1 bombón y 1 caramelo. Al finalizar el día sobraron 12 bombones y 25 caramelos. ¿Cuántos clientes en total (personas adultas e infantes) tuvo la tienda ese día?"}
		\item Una mueblería fabrica sillas, mesas y armarios. Cada mesa requiere 2m$^2$ de madera, 20 tornillos y 3m de	caños de hierro. Cada silla requiere 1m$^2$ de madera, 16 tornillos y 2m de caños. Cada armario requiere el doble de materiales que una mesa. Responder las siguientes preguntas utilizando herramientas vistas en la asignatura. Si se quieren fabricar 1 mesa, 4 sillas y 2 armarios, ¿cuántos materiales de cada tipo se necesitan? Si la mueblería compró 21m$^2$ de madera, 240 tornillos y 34m de caño, ¿qué opciones de fabricación tiene si se desea consumir todos los materiales?
		\item Una pinturaría vende pintura, diluyente y barniz, en latas de 1~L, 3~L y 1~L, respectivamente. Cada lata cuesta 5\$, 6\$ y 7\$, respectivamente. Un día se vendió un lote de 32~L que contenía 20 latas, por lo que se cobr ́o 112\$. Averiguar cuántas latas de cada tipo contenía el lote vendido utilizando herramientas vistas en la materia.
		\item En el cine están las siguientes promociones: \\ \begin{center} \begin{tabular}{|c|c|c|} \hline Combo A & 1 pochoclo y 2 gaseosas & \$1300 \\ \hline Combo B & 3 gaseosas y 3 nachos & \$2700 \\ \hline Combo C & 1 pochoclo, 1 gaseosa y 1 nacho & \$1600 \\ \hline \end{tabular} \end{center} \\ Averigua cuántas gaseosas se venderían si se piden 10 combos A, 8 combos B y 14 combos C. Además, determina la cantidad de combos de cada tipo vendidos si se prepararon 17 pochoclos, 60 gaseosas y 46 nachos.
		\item Alguien dijo que el sistema $\SEL{2t-3d+2h=0 \\ -2t-11d-14h=0 \\ t+2d+4h=0 \\ -4t+13d+2h=0}$ es incompatible porque tiene tres incógnitas ($t$, $d$ y $h$) y cuatro ecuaciones. Explica si tiene razón o no, y porqué. Finalmente, resuelve el sistema para comprobarlo.
