...
\begin{enumerate}
	...
	\begin{enumcols}
		...
		\answer La lata se debe modelizar como un cilindro de base circular. \\ \img{4cm}{./img/lata.png} \\ El área es $A(r)=2 \pi r^2+ 14 \pi r$ (en cm$^2$) y el volumen es $V(r)=4 \pi r^2$ (en cm$^3$). Si el radio es $5$, tenemos que $A(5)=120\pi \simeq 376.9911$ (en cm$^2$) y que $V(r)=100\pi \simeq 314.1593$ (en cm$^3$)

		\item Se realiza una caja sin tapa de acuerdo al esquema de la foto. Calcular el área de la base y el volumen de la caja en función de la medida $x$. Indicar cuanto debe medir $x$ para que la caja tenga un volumen de 400 cm$^3$: \img{4cm}{img/box.png} 
